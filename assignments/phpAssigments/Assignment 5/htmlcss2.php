      ...
      <?php
            ...
            if(isset($_POST['submit'])){
              ...
              include 'phpAssignments/CValidator.php';
                    ...
                    $flag = validate($job_title,$company_name,$location,$job_description,$salary,$key_skills);
                    if($flag==1)
                    {
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="row form-group">
                      <div class="col-md-12 font-weight-bold"><h5>Key Skills</h5></div>
                        <div class="col-md-12 ">
                          <input type="text" name="key_skills" value="<?php if(isset($_POST['key_skills'])){echo $_POST['key_skills'];}?>" id="hidecursor5" onKeyPress="hidecursor()" name="job-type" class="form-control" placeholder="eg. C, C++, Java.">
                      </div>
                    </div>
