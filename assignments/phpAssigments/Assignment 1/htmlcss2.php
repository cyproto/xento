                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="row form-group">
                      <div class="col-md-12 font-weight-bold"><h4>Job Description</h4></div>
                        <div class="col-md-12 ">
                          <textarea name="job_description" value="<?php if(isset($_POST['job_description'])){echo $_POST['job_description'];}?>" onKeyPress="hidecursor()" id="hidecursor4" class="form-control" id="" cols="30" rows="5"></textarea>
                      </div>
                    </div>
