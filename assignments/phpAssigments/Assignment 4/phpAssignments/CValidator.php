<?php 
    function validate($job_title,$company_name,$location,$job_description,$salary,$job_type)
    {
        ...
        else
        {
            ...
            $insertQuery = "INSERT INTO jobs(salary,job_title,company,job_type,location,job_description) VALUES('$sal','$job_title','$company_name','$job_type','$location','$job_description')";
