        ...
        <div class="bg-light" style="padding-top: 5%; padding-left: 7%; padding-right: 7%;">
              ...
              <div class="row">
                <div class="col-md-12 col-lg-12 ">
                       <form action="#" class="p-5">
                         ...
                         <a href="" id="edit_<?php echo $row['id'];?>"><i class="fa fa-edit" id="edit_but_<?php echo $row['id'];?>" style="display:none;"></i></a>
          ...
          <script>
            $('#editanddelete_<?php echo $row['id'];?>').hover(
              function(){
                $('#edit_but_<?php echo $row['id'];?>').show();
              },
              function(){
                $('#edit_but_<?php echo $row['id'];?>').hide();
              });
          </script>
          <script>
              $('a#edit_<?php echo $row['id'];?>').click(
                function(){
                  var id = <?php echo $row['id'];?>;
                  window.open("htmlcss2.php?id="+id);
                });
          </script>
          <?php } ?>
