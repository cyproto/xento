              ...
              <div class="row">
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-md-12 ">
                        <input type="text" name="job_title" value="<?php echo $row['job_title'];?>" onKeyPress="hidecursor()" id="hidecursor1" class="form-control" placeholder="eg. Professional UI/UX Designer" >
                      </div>
                    </div>
                    <div class="row form-group ">
                        <div class="col-md-12 font-weight-bold"><h5>Company</h5></div>
                        <div class="col-md-12 ">
                          <input type="text" name="company_name" value="<?php echo $row['company'];?>" onKeyPress="hidecursor()" id="hidecursor2" class="form-control" placeholder="eg. Facebook, Inc.">
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group mb-4">
                      <div class="col-md-12 font-weight-bold"><h4>Location</h4></div>
                        <div class="col-md-12 ">
                          <input type="text" name="location" value="<?php echo $row['location'];?>" onKeyPress="hidecursor()" id="hidecursor3" class="form-control" placeholder="Western City, UK">
                        </div>
                    </div>
                    <div class="row form-group">
                      <div class="col-md-12 font-weight-bold"><h4>Job Description</h4></div>
                        <div class="col-md-12 ">
                          <textarea name="job_description" onKeyPress="hidecursor()" id="hidecursor4" class="form-control" id="" cols="30" rows="5"><?php echo $row['job_description'];?></textarea>
                      </div>
                    </div>
